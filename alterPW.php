        ...
        <main>
            ...
            <div class="card-body d-flex flex-column align-items-center">
                ...
                <form class="text-center" method="post" action="customers.php">
                    ...
                    <div class="mb-3"><input class="form-control" type="email" name="oldPWToReplace" placeholder="celui avec lequel vous vous êtes connecté" />Ancien mot de passe</div>
                    <div class="mb-3"><input class="form-control" type="text" name="newPWToAdd" placeholder="doit contenir"/>Nouveau mot de passe</div>
                    <div class="mb-3"><input class="form-control" type="text" name="verifiedPWToAdd" placeholder="identique" />Confirmer</div>
